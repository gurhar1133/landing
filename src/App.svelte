...
<div class="relative w-screen">
  ...
  <div class="clouds relative">
      ...
      <svg viewBox="0 0 150 150">
        <g id="Logo">
          <g id="Group_2">
            <path
              id="Vector_65"
              d="M67.7 80.1L84.5 70.5C84.9 70.3 85.2 69.8 85.2 69.3V50.5C85.2 50
              84.9 49.6 84.5 49.4L68.2 39.9C67.8 39.7 67.3 39.7 66.9 39.9L50.6
              49.2C50.2 49.4 49.9 49.9 49.9 50.3V70V88.2C49.9 89.2 51 89.9 51.9
              89.4L67.7 80.1ZM82 67.6L70.7 61C69.8 60.5 69.8 59.2 70.7 58.7L82.1
              52.2C83 51.7 84.1 52.3 84.1 53.4L84 66.5C84 67.5 82.9 68.1 82
              67.6ZM70.2 42.3L81.5 48.9C82.4 49.4 82.4 50.7 81.5 51.2L70.1
              57.7C69.2 58.2 68.1 57.6 68.1 56.5L68.2 43.4C68.2 42.5 69.3 41.8
              70.2 42.3ZM70.1 62.1L81.4 68.7C82.3 69.2 82.3 70.5 81.4 71L70.1
              77.5C69.2 78 68.1 77.4 68.1 76.3L68.2 63.2C68.1 62.2 69.3 61.5
              70.1 62.1ZM64.9 77.4L53.6 70.8C52.7 70.3 52.7 69 53.6 68.5L65
              62C65.9 61.5 67 62.1 67 63.2L66.9 76.3C66.9 77.3 65.8 77.9 64.9
              77.4ZM67.1 43.5L67 56.6C67 57.6 65.9 58.3 65 57.7L53.7 51.1C52.8
              50.6 52.8 49.3 53.7 48.8L65.1 42.3C66 41.8 67.1 42.5 67.1
              43.5ZM53.1 52.1L64.4 58.7C65.3 59.2 65.3 60.5 64.4 61L53 67.5C52.1
              68 51 67.4 51 66.3L51.1 53.2C51.1 52.2 52.3 51.6 53.1 52.1ZM53.1
              71.8L64.4 78.4C65.3 78.9 65.3 80.2 64.4 80.7L53 87.2C52.1 87.7 51
              87.1 51 86L51.1 73C51.1 71.9 52.2 71.3 53.1 71.8Z"
              fill="white"
              stroke="white"
              stroke-width="2"
            ...
            <path
              id="Vector_66"
              opacity="0.2"
              d="M96.6 102.1H37.6C32.4 102.1 28.3 97.9 28.3 92.8V33.8C28.3 28.6
              32.5 24.5 37.6 24.5H96.5C101.7 24.5 105.8 28.7 105.8
              33.8V92.7C105.9 97.9 101.7 102.1 96.6 102.1Z"
              fill="white" />
          </g>
        </g>
      </svg>
    ...
    <div id="background" class="">
      <svg
        viewBox={`${backgroundLeftLimit} 0 ${backgroundRightLimit} 1080`}
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
